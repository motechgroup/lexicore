<div>
    ...
    <div class="mb-8">
        ...
        <h1 class="font-display-lg text-3xl text-primary dark:text-white mb-1 font-bold">Open Legal Matter</h1>
        <p class="text-slate-500 dark:text-slate-400 text-sm">Register a new client representation folder and assign counselors.</p>
    </div>
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-6 shadow-sm space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                    <div class="md:col-span-2">
                        ...
                        <input wire:model="title" id="title" type="text" placeholder="e.g. Smith v. Meridian Corp."
                    ...
                    <div>
                        ...
                        <input wire:model="case_number" id="case_number" type="text"
                               class="block w-full px-4 py-2.5 text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl focus:outline-none text-slate-500 font-mono" />
                ...
                <div>
                    ...
                    <textarea wire:model="description" id="description" rows="5" placeholder="Detail the legal claims, background, and objectives..."
            ...
            <div class="bg-white dark:bg-[#1e293b] rounded-2xl border border-slate-200/80 dark:border-slate-800/80 p-6 shadow-sm space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input wire:model="case_value" id="case_value" type="number" step="0.01" placeholder="e.g. 50000"
                               class="block w-full px-3 py-2 text-xs bg-white border border-slate-200 dark:border-slate-800 dark:bg-slate-900/65 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-850 dark:text-slate-250" />
                ...
                <div>
                    ...
                    <input wire:model="court" id="court" type="text" placeholder="e.g. Southern District Court NY"
                ...
                <div>
                    ...
                    <input wire:model="judge" id="judge" type="text" placeholder="e.g. Hon. Richard Sullivan"
                           class="block w-full px-4 py-2.5 text-xs bg-white border border-slate-200 dark:border-slate-800 dark:bg-slate-900/65 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-850 dark:text-slate-250" />
                ...
                <div class="border-t border-slate-100 dark:border-slate-800/60 pt-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model="opposing_party" id="opposing_party" type="text" placeholder="e.g. Meridian Corp."
                               class="block w-full px-4 py-2.5 text-xs bg-white border border-slate-200 dark:border-slate-800 dark:bg-slate-900/65 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-850 dark:text-slate-250" />
                    ...
                    <div>
                        ...
                        <input wire:model="opposing_counsel" id="opposing_counsel" type="text" placeholder="e.g. Sarah Vance, Esq."
                               class="block w-full px-4 py-2.5 text-xs bg-white border border-slate-200 dark:border-slate-800 dark:bg-slate-900/65 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-slate-850 dark:text-slate-250" />
